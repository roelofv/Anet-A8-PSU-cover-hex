...
//     cell is 8 + 2(2) = 12.
////////////////////////////////////////////////////////////////////
module cell(SW_hole, height, cellwall) {
  tol = 0.001; // used to clean up difference artifacts
  difference() {
    cyl(d=SW_hole+2*cellwall,h=height,$fn=6,circum=true);
...
//     rectangular frame
////////////////////////////////////////////////////////////////////
module create_grid(size,SW,cellwall,wall) {
  b = 2*wall;
  union() {
    difference () {
      cuboid(size=size);
  ...
  difference() {
    grid(size=size,cell_hole=SW,cell_wall=cellwall);
    mask(size);
  }
}
...
//   wall: (thickness of outside wall
//   cellwall:  (thickness of hex wall
////////////////////////////////////////////////////////////////////
// create_grid(size=[584,311,5],SW=10,cellwall=1,wall=10);
